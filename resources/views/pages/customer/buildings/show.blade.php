    ...
    <div class="container my-6">
        ...
        <div id="buildingImages" class="carousel slide shadow-lg">
            ...
            <div class="carousel-inner">
                @forelse($building->images as $image)
            ...
            <div class="card bg-white p-3">
                <div class="card-body">
                    <div class="row row-cols-3 align-items-center">
                        @forelse($building->amenities()->get() as $roomAmenity)
                            <div class="col">
            ...
            <div class="card bg-white p-3">
                <div class="card-body">
                    <div class="row row-cols-3">
                        @forelse($building->nearbyFacilities as $nearbyFacility)
                            <div class="col">
                    ...
                    @if(count($building->images) > 0)
                        <div class="card">
                            <div class="img-detail-building">
                                <img src="{{
                                    Storage::exists('public/' . $building->images[0]->image) ?
                                    Storage::url($building->images[0]->image) : $building->images[0]->image
